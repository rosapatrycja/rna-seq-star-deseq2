...
sortedcounts_CNSvsS2<- maxlogfc_genes(CNSvsS2_dge,100,data_cpm)
sortedcounts_CNSvsBG3 <- maxlogfc_genes(CNSvsBG3_dge,100,data_cpm)
sortedcounts_BG3vsS2 <- maxlogfc_genes(BG3vsS2_dge,100,data_cpm)

```


### Expression levels for 100 differentialy expressed genes with the highest value of log fold change in Central nervous system and S2 contrast
...
### Expression levels for 100 differentialy expressed genes with the highest value of log fold change in Central nervous system and BG3 contrast
...
### Expression levels for 100 differentialy expressed genes with the highest value of log fold change in BG3 and S2 contrast
