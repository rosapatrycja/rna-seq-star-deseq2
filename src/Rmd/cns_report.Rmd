...
```{r, echo=FALSE}
#read counts file 
data <- read.delim('P:/Desktop/work/rna-seq-cns/all.tsv')
...
CNSvsS2_dge <- significant_genes(CNSvsS2_adj,alpha = 0.05, logfc = 2)
CNSvsBG3_dge <- significant_genes(CNSvsBG3_adj,alpha = 0.05, logfc = 2)
BG3vsS2_dge<- significant_genes(BG3vsS2_adj,alpha = 0.05, logfc = 2)
