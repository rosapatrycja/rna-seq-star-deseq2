pdf("qc/rseqc/ML.DmBG3.c2.124-rep2.junctionanno.splice_events.pdf")
events=c(0.0,99.90438172786875,0.0)
...
dev.off()
pdf("qc/rseqc/ML.DmBG3.c2.124-rep2.junctionanno.splice_junction.pdf")
