pdf("qc/rseqc/S2.DRSC.16-rep2.junctionanno.splice_events.pdf")
events=c(0.0,99.88947700171829,0.0)
...
dev.off()
pdf("qc/rseqc/S2.DRSC.16-rep2.junctionanno.splice_junction.pdf")
