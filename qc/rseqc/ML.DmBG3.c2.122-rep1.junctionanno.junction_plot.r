pdf("qc/rseqc/ML.DmBG3.c2.122-rep1.junctionanno.splice_events.pdf")
events=c(0.0,99.90605138171398,0.0)
...
dev.off()
pdf("qc/rseqc/ML.DmBG3.c2.122-rep1.junctionanno.splice_junction.pdf")
