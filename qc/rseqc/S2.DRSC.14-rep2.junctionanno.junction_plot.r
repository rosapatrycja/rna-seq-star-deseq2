pdf("qc/rseqc/S2.DRSC.14-rep2.junctionanno.splice_events.pdf")
events=c(0.0,99.90938513511233,0.0)
...
dev.off()
pdf("qc/rseqc/S2.DRSC.14-rep2.junctionanno.splice_junction.pdf")
