pdf("qc/rseqc/ML.DmBG3.c2.122-rep2.junctionanno.splice_events.pdf")
events=c(0.0,99.90559696328661,0.0)
...
dev.off()
pdf("qc/rseqc/ML.DmBG3.c2.122-rep2.junctionanno.splice_junction.pdf")
