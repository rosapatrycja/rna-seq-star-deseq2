...
#read counts file 
data <- read.delim('/home/rosa/rna-seq-star-deseq2/counts_1/all.tsv')
rownames(data) <- data[,1]
data <- data[,-1]
data_cpm <- cpm(data)

#read model statistics value table 
statistics <- read.table('/home/rosa/rna-seq-star-deseq2/deseq2_1/ML.DmBG3.c2-vs-S2.DRSC.diffexp.tsv')
